...
skip_digest_oid:
    ...
    switch (cert->signature.oid.oid[6]) {
        case 4: /* md5WithRSAEncryption */
            wpa_md5_vector(1, &cert->tbs_cert_start, &cert->tbs_cert_len,
                           hash);
            hash_len = 16;
        ...
        case 5: /* sha-1WithRSAEncryption */
            wpa_sha1_vector(1, &cert->tbs_cert_start, &cert->tbs_cert_len,
                            hash);
            hash_len = 20;
        ...
        case 11: /* sha256WithRSAEncryption */
            wpa_sha256_vector(1, &cert->tbs_cert_start, &cert->tbs_cert_len,
                              hash);
            hash_len = 32;
